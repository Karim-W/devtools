export default function LeftTab({ Tabs, handleTabChange }: { Tabs: string[], handleTabChange: (tab: string) => void }) {
	return <div className={`bg-gradient-to-tl from-stone-900 to-stone-700 inset-0 bg-gradient-to-tl from-stone-900 to-stone-700
